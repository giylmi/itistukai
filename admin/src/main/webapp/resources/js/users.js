...
$(document).ready(function () {
    ...
    function updateUsersTab() {
        ...
        $.post(window.contextPath + '/users/all', function (data) {
            $tab.html(data);
        });
    }
    ...
    function updateAdminsTab() {
        ...
        $.post(window.contextPath + '/users/admins', function (data) {
            $tab.html(data);
        });
    }
    ...
    function bindCreateUserBtn() {
        $('#createUserBtn').on('click', function () {
            ...
            $.post(window.contextPath + '/users/register', $form.serialize(), function (data) {
                $tab.html(data);
                bindCreateUserBtn();
            });
        });
