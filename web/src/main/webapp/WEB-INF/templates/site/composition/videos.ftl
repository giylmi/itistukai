...
<#macro user_block video>
    <#if video.videoType == 'INSTAGRAM'>
    <div class="media js-media">
        <div class="media-left">
            <a target="_blank" class="js-is-link"
               href="https://instagram.com/${(video.instagramUser.userName)!"#"}">
                <img class="media-object js-is-link"
                     src="${(video.instagramUser.profilePicture)!}"
                     alt="" style="width: 64px;height: 64px"/>
            </a>
        </div>
        <div class="media-body">
            <h4 class="media-heading"><a class="js-is-link" target="_blank"
                                         href="https://instagram.com/${(video.instagramUser.userName)!"#"}">
            ${(video.instagramUser.fullName)!""}
            </a></h4>
            <#if video.instagramUrl??>
                <a class="js-is-link" target="_blank"
                   href="${video.instagramUrl}"><@spring.message code="site.lookat.instagram"/></a>
            </#if>
        </div>
    </div>
    <#else>
    <div class="media js-media">
        <div class="media-left">
            <a target="_blank" class="js-is-link"
               href="https://vk.com/${(video.vkOwner.ownerLink)!"#"}">
                <img class="media-object js-is-link"
                     src="${(video.vkOwner.ownerPhoto)!}"
                     alt="" style="width: 64px;height: 64px"/>
            </a>
        </div>
        <div class="media-body">
